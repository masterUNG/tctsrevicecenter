...
class hiks extends StatelessWidget {
  const hiks({Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            Align(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                      "ข้อตกลงและเงือนไขการรับประกันสินค้า Hikvision\n",
                      style: kTextHeadB,
                    ),
                  ],
                )),
            ...
            const Text(
                "• เป็นการรับประกันเฉพาะตัวสินค้าเท่านั้นไม่รวมอุปกรณ์ที่แถมไปกับตัวสินค้า",
                style: kTextSub),
            const Text(
            ...
            const Text(
                ...
                style: kTextHead),
            const Text(
                "ข้อ 4.1 รับประกัน 3 ปี สำหรับสินค้าประเภท Analog Cameras, DVR/NVR, DVS, IPC, Speed dome, Thermal imaging",
                style: kTextSub),
            const Text(
