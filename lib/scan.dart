...
import 'package:tctservicecenter/warranty/searchwar.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_barcode_scanner/flutter_barcode_scanner.dart';

void main() => runApp(const Myscan());
    ...
    setState(() {
      ...
      if (barcodeScanRes != '-1') {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => swaranty(search: _scanBarcode)));
      }
    });
  }
              ...
              return Container(
                  ...
                  child: Flex(
                      ...
                      children: <Widget>[
                        // ignore: prefer_const_constructors
                        Text(
                          "สแกนหมายเลขซีเรียลของผลิตภัณฑ์",
                          // ignore: prefer_const_constructors
                          style: TextStyle(
                              fontSize: 14,
                        ...
                        // ignore: prefer_const_constructors
                        Text(
                          "(Scan the serial number of the product.)",
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: kPrimaryColor.withOpacity(0.8), width: 2),
            ),
            child: TextFormField(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  swaranty(search: _textController.text)));
                    },
                  ),
                ),
              ],
